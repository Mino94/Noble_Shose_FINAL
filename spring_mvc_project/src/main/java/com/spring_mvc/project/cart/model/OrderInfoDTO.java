package com.spring_mvc.project.cart.model;

public class OrderInfoDTO {
/*
 * CREATE TABLE order_info(
    ordNo VARCHAR2(20) NOT NULL PRIMARY KEY,
    ordDate DATE DEFAULT SYSDATE,
    memID VARCHAR2(10),
    ordReceiver VARCHAR2(30),
    ordRcvZipcode VARCHAR2(6),
    ordRcvAddress1 VARCHAR2(50),
    ordRcvAddress2 VARCHAR2(50),
    ordRcvPhone VARCHAR2(14),
    ordRcvMsg VARCHAR2(30),
    ordPay VARCHAR2(30),
